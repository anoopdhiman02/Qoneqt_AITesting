...
const ReportProfileScreen = () => {
  ...
  return (
    <ViewWrapper>
      <View style={{ width: "90%" }}>
        <GoBackNavigation header="Report post" isDeepLink={true} />
        <Text
          style={{
            fontSize: 16,
            lineHeight: 21,
        ...
        <ScrollView style={{ height:'60%'}} contentContainerStyle={{paddingBottom:'20%'}}>
        ...
        >
          ...
          <Text style={{ color: globalColors.neutral4, left: "15%" }}>
            Note: You will be automatically blocked user
          </Text>
        </View> */}
