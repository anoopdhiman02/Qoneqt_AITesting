...
const UserProfileScreen = () => {
  ...
  const onPressFollowOption = () => {
    ...
    dispatch(updateProfileViewData({...profileDetailsData?.data,follow_by_me: profileDetailsData?.data.follow_by_me == 1? 0 : 1}));
  };
        ...
        {profileDetailsData?.data?.block_by_user == 0 ? (
          ...
          <ProfileButton
            label={
                ...
                >
                  {profileDetailsData?.data?.follow_by_me == 1 ? "Following" : "Follow"}
                </Text>
            }
