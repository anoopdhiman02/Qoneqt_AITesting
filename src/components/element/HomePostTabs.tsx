          ...
          return (
            <TouchableOpacity
              ...
              style={{
                ...
                marginHorizontal: 8,
                flexDirection: "row",
                borderColor: isSelected ? globalColors.warmPinkTint100 : "transparent",
              ...
              <Text
                style={{
                  ...
                  color: isSelected
                    ...
                    : globalColors.neutral11,
                }}
              >
                {data.label}
              </Text>
              {data.icon && data.id === 1 && <data.icon fill={isSelected ? globalColors.warmPinkTint100 : globalColors.neutral11} />}
              {isSelected && (
                <View
                  style={{
