...
interface CustomMuteNotificationViewProps {
    select: number;
...
const CustomMuteNotificationView:FC<CustomMuteNotificationViewProps> = ({select, setSelect, mutePress, cancelPress}) => {
...
export default CustomMuteNotificationView
