...
const AnimatedFire = ({ size = 22 }) => {
  ...
  return (
    <Animated.View style={{ opacity: flickerAnim }}>
      <Ionicons name="flame" size={size} color="#ff6b35" />
    </Animated.View>
  );
};
...
const DashboardHeader = memo<DashboardHeaderProps>(({
  ...
  const handleTrendingPress = useCallback(() => {
    logEvent("trending_click");
    router.push("/TrendingPost");
  }, []);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.topRightIcons}>
        ...
        >
          ...
          /> */}
          <LottieView
            source={require("../../assets/lottie/Fire.json")} // Download from LottieFiles
            autoPlay
            loop
