...
const MyPostContainer = React.memo(({
  ...
  const dynamicStyles = useMemo(() => ({
    ...
    bottomMarginBottom: derivedData.isMediaPost || derivedData.isAudio ? 30 : 1,
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity onPress={handlePressPost}>
        {/* Header Section */}
        <View style={[styles.header, { marginTop: dynamicStyles.headerMarginTop }]}>
          <View style={styles.userInfo}>
            ...
            <View style={styles.userDetails}>
              <TouchableOpacity disabled={isSelf} onPress={handlePressProfile} style={styles.nameContainer}>
                <Text style={styles.userName}>
                  {derivedData.fullName}
                </Text>
          ...
          {derivedData.categoryName ? (
            <TouchableOpacity onPress={handlePressCategory} style={styles.categoryButton}>
        ...
        <View style={styles.contentSection}>
          <Text
            ...
            numberOfLines={isExpanded ? undefined : (derivedData.postContent.length > 100 ? 2 : 3)}
          >
      ...
      <View style={[
        ...
        <View style={styles.actionsContainer}>
          ...
          <TouchableOpacity onPress={handlePressComment} style={styles.commentButton}>
